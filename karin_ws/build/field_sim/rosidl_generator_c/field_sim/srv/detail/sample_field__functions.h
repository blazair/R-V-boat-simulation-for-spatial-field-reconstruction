...
#ifndef FIELD_SIM__SRV__DETAIL__SAMPLE_FIELD__FUNCTIONS_H_
#define FIELD_SIM__SRV__DETAIL__SAMPLE_FIELD__FUNCTIONS_H_
...
#include "field_sim/msg/rosidl_generator_c__visibility_control.h"
...
/// Initialize srv/SampleField message.
/**
 ...
 * )) before or use
 * field_sim__srv__SampleField_Request__create()
...
/// Finalize srv/SampleField message.
/**
...
/// Create srv/SampleField message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * field_sim__srv__SampleField_Request__init().
...
/// Destroy srv/SampleField message.
/**
 * It calls
 * field_sim__srv__SampleField_Request__fini()
...
/// Check for srv/SampleField message equality.
/**
...
/// Copy a srv/SampleField message.
/**
...
/// Initialize array of srv/SampleField messages.
/**
...
/// Finalize array of srv/SampleField messages.
/**
 * It calls
 * field_sim__srv__SampleField_Request__fini()
...
/// Create array of srv/SampleField messages.
/**
...
/// Destroy array of srv/SampleField messages.
/**
 * It calls
 * field_sim__srv__SampleField_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SampleField message array equality.
/**
...
/// Copy an array of srv/SampleField messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * )) before or use
 * field_sim__srv__SampleField_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_field_sim
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * field_sim__srv__SampleField_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_field_sim
...
/**
 * It calls
 * field_sim__srv__SampleField_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_field_sim
...
/**
 * It calls
 * field_sim__srv__SampleField_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * field_sim__srv__SampleField_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_field_sim
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * field_sim__srv__SampleField_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_field_sim
...
/**
 * It calls
 * field_sim__srv__SampleField_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_field_sim
...
/**
 * It allocates the memory for the array and calls
 * field_sim__srv__SampleField_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_field_sim
...
/**
 * It calls
 * field_sim__srv__SampleField_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // FIELD_SIM__SRV__DETAIL__SAMPLE_FIELD__FUNCTIONS_H_
