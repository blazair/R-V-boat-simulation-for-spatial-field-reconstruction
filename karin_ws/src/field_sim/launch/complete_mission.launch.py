...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        LogInfo(msg="Starting Complete Lawnmower Mission System..."),
        ...
        # Wait for Gazebo to be ready, then start everything else
        TimerAction(
            period=8.0,
            actions=[
                
                # Ground Truth Temperature Field (provides /sample_field service)
                Node(
                    package='field_sim',
                ...
                # Odometry Bridge (remap to /wamv/odom)
                Node(
                    package='ros_gz_bridge',
                    executable='parameter_bridge',
                    name='odom_bridge',
                ...
                # Field Sampler (temperature sampling)
                Node(
                    package='field_sim',
